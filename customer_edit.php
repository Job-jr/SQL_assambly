...
<!-- ------------------------------- content ------------------------------- -->
        <div class="content">
            <div class="content-data">
                <table>
                        ...
                        <?php
                            ...
                            $sql = mysqli_query($conn, "SELECT cus_firstname, cus_tel, cus_add FROM customer");
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="customer_edit.php?cus_firstname=<?php echo $row["cus_firstname"];?>"><i class='fas fa-pencil-alt' style='font-size:20px;color:green;margin: 0px 15px 0px 0px'></i></a>
                                    <a href="javascript:delete_cus(<?php echo ["cus_firstname"];?>)"><i class='fas fa-trash-alt' style='font-size:20px;color:red;margin: 0px 15px 0px 0px'></i></a>
                                </td>    
                            </tr>
                        <?php } ?>
                        </tbody>
            ...
            $conn = new mysqli('localhost','root','','sql_assembly');  
            $strcus_firstname = null;

            if(isset($_GET["cus_firstname"])){
                $strcus_firstname = $_GET["cus_firstname"];
            } 

            $sql = "SELECT * FROM customer WHERE cus_firstname =  '".$strcus_firstname."' ";
            ...
            <form action="get_DB.php" class="modal-1" method="get">
                <div class="modal-dialog">
                    <section class="modal-content">
                        <header class="modal-header">
                            <h3 class="modal-title">เพิ่มข้อมูลลูกค้า</h3>
                            <a class="modal-btn-close" href="customer.php"><i class="fas fa-times"></i></a>
                        </header>
                            <div class="modal-body">
                                <ul>
                                <input type="hidden" name="txt_cus_id" class="text" value="<?php echo $result["cus_id"]; ?>">
                                    <li><t>ชื่อลูกค้า</t><i><input type="text" class="text" name="txt_cus_firstname" value="<?php echo $result["cus_firstname"];?>"></i></li>
                                    <li><t>ที่อยู่</t><i><textarea id="" cols="num" rows="num" name="txt_cus_add"><?php echo $result["cus_add"] ?></textarea></i></li>
                                    <li><t>เบอร์โทรศัพท์</t><i><input type="text" class="text" name="txt_cus_tel" value="<?php echo $result["cus_tel"];?>"></i></li>
                                </ul>
                            </div>
                        <footer class="modal-footer">
                            <div class="footer-btn">
                                <input class="modal-btn-01 "type="submit" value="บันทึก" name="submit-update-customer-btn">
                            </div>
                        </footer>
                    </section>
                </div>
