        ...
        <div class="header">
            <div class="title">
                <div class="title-text">
                    <h2>ตารางงาน</h2>
                    <div class="title-btn">
                        <button class="title-btn-01">เพิ่มงาน<i class="fas fa-plus" style="margin-left: 6px;"></i></button>
                        <button class="title-btn-02"><i class="fas fa-search" style="margin-right: 6px;"></i>ค้นหา</button>
                    </div>
                </div>
            </div>
        </div>
...
<!-- ------------------------------- content ------------------------------- -->
        ...
        <div class="content">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil architecto dolorum tempora dicta cum iure, saepe laborum est labore et repellat, repudiandae sapiente autem pariatur deserunt modi dolorem debitis ad.
